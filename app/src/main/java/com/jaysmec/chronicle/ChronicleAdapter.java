...
public class ChronicleAdapter extends RecyclerView.Adapter<ChronicleAdapter.MyViewHolder> {
    ...
    public ChronicleAdapter(ArrayList<Data> list, Context c) {
        this.datalist = list;
        this.cc=c;
    }
    ...
    public void onBindViewHolder(MyViewHolder holder, final int position) {
        ...
        //holder.locanddata.setText(data.address+", "+data.temp+"°C");
            holder.locanddata.setText(data.address); }
        else
            holder.locanddata.setText(data.address+", "+data.temp);
        holder.lin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent viewer=new Intent(cc,Viewerch.class);
                viewer.putExtra("pos",position);
                cc.startActivity(viewer);
                //((Activity)cc).finish();
            }
        });
