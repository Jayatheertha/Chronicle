...
public class NewView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent viewerf=getIntent();
        pos=viewerf.getExtras().getInt("pos");
        viewerda=Tags.curr.get(pos);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch(item.getItemId())
        {
            ...
            case R.id.delete:
                ...
                alertDialogBuilder.setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent backj=new Intent(NewView.this,Chronicle.class);
                        Toast.makeText(NewView.this, "Delete successful", Toast.LENGTH_SHORT).show();
            ...
            case R.id.copy:
                ...
                break;
            case R.id.edit:
                Intent editerd=new Intent(this,NewUpdate.class);
